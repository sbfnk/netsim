  ...
  : Model(v)
{
  ...
  rates.insert(std::make_pair("theta", &theta));
...
//----------------------------------------------------------
unsigned int Models::VaccinationSIRS::getNodeEvents(eventList& events,
                                                    State state,
...
//----------------------------------------------------------
unsigned int Models::VaccinationSIRS::getEdgeEvents(eventList& events,
                                                    State state,
                                                    unsigned int edge,
                                                    State nbState,
                                                    unsigned int nb) const
